...
from robolink import Robolink, ITEM_TYPE_ROBOT  # Correct import for ITEM_TYPE_ROBOT
...
# Retrieve the robot item
try:
    robot = RDK.Item('', ITEM_TYPE_ROBOT)
    if not robot.Valid():
        raise ValueError("No valid robot found in RoboDK station.")
except TimeoutError:
    raise TimeoutError("Connection to RoboDK timed out. Please check your network or RoboDK status.")
